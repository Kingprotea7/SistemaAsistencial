...
<div class="container mt-5">
    <div class="custom-card-header bg-primary text-white text-center">
        <h1 class="card-title text-center">Nivel Secundaria</h1>
    </div>
    <div class="row">
        <div class="col-md-4 ">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('Salones.listarS2', ['grade' => '1']) }}" class="btn btn-primary">Ir</a>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('Salones.listarS2', ['grade' => '2']) }}" class="btn btn-primary">Ir</a>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('Salones.listarS2', ['grade' => '3']) }}" class="btn btn-primary">Ir</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('Salones.listarS2', ['grade' => '4']) }}" class="btn btn-primary">Ir</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('Salones.listarS2', ['grade' => '5']) }}" class="btn btn-primary">Ir</a>
                </div>
            </div>
        </div>
